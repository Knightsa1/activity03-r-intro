...
**Response**: There wasn't a comma between H and I and also the commas and quotations were off in the punctuation vector. It is about noticing when there are the error lines underneath and is everything the right color.
...
**Response**: cbind is not the correct function to be using. When making a vector it should be c.
...
**Response**: There was a missing period between data and frame. Also we are renaming it to be Symbol so that should be in parentheses.
...
**Response**: It wasn't count the number  of observations. I needed to count the rows so I looked up how to do it.
...
**Response**: I needed to change % to $.
...
**Response**: This activity was to help us figure out how to work with errors, but also to have us start to mess around with some of the functions.
